...
public class RandevuBean {
    ...
    public ResultSet onayRandevuGetir() throws SQLException {
        if (dataSource == null) {
            throw new SQLException("Unable to obtain DataSource");
        }
        ...
        try {
            PreparedStatement stmt = connection.prepareStatement(
                    "SELECT * FROM ONAY_RANDEVULAR");
            CachedRowSet resultSet2 = new com.sun.rowset.CachedRowSetImpl();
            resultSet2.populate(stmt.executeQuery());
            return resultSet2;
        } finally {
            connection.close();
        }
    ...
    public ResultSet redRandevuGetir() throws SQLException {
        if (dataSource == null) {
            throw new SQLException("Unable to obtain DataSource");
        }
        ...
        try {
            PreparedStatement stmt = connection.prepareStatement(
                    "SELECT * FROM RED_RANDEVULAR");
            CachedRowSet resultSet3 = new com.sun.rowset.CachedRowSetImpl();
            resultSet3.populate(stmt.executeQuery());
            return resultSet3;
        } finally {
            connection.close();
        }
    ...
    public String randevuEkle() throws SQLException {
        ...
        try {
            ...
            facesContext.addMessage("randevuid:randevual", facesMessage);
    ...
    public String randevuOnay(String id) throws SQLException {
        ...
        try {
            PreparedStatement statement = connection.prepareStatement("INSERT INTO ONAY_RANDEVULAR "
                    + "SELECT * FROM RANDEVULAR WHERE ID = ?");
            PreparedStatement statement2 = connection.prepareStatement("DELETE FROM RANDEVULAR WHERE ID=?");
            ...
            return "/randevular.xhtml?faces-redirect=true";
    ...
    public String randevuRed(String id) throws SQLException {
        ...
        try {
            PreparedStatement statement = connection.prepareStatement("INSERT INTO RED_RANDEVULAR "
                    + "SELECT * FROM RANDEVULAR WHERE ID = ?");
            PreparedStatement statement2 = connection.prepareStatement("DELETE FROM RANDEVULAR WHERE ID=?");
            int num = Integer.valueOf(id);
            statement.setInt(1, num);
